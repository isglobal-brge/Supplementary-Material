...
#2. Filtering inputs
case_samples <- object[,c("GSM3035933", "GSM3035791", "GSM3035807","GSM3035685")]
control_samples <- object[,GSE111629$disease_state == "control"]
...
results.name <- paste0("outputfile-", variable,"-", n, "-", i)
