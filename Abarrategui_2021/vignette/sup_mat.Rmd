...
Finally, a `GenomicRatioSet` class object should be the input of the main function,  `epimutations()` function. Case samples and reference panel are introduced separately. 
