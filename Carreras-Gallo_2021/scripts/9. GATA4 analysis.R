...
#####################################################################
## cg16810626 (GATA4) methylation - Congenital Heart Defects (CHD) ##
#####################################################################
...
#all CpG sites evaluated in heart tissue samples
load("../../results/methylation/finalQC_files/2021-03-08/gset.autosomic.Rdata")

#CpG sites within GATA4 differentially methylated by any interaction
gata4_cpgs <- read.table("../../data/Natalia_cpgs_gata4.txt")$V1


# Run linear model (controls vs CHD) in all CpG sites
...
# Select CpG sites from gata4_cpgs vector
tab[rownames(tab) %in% gata4_cpgs, ]

# Boxplot comparing methylation in cases and controls for the significant CpG sites
